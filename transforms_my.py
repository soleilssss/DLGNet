...
# from torchvision.transforms.functional import functional as F
...
class RandomRotation(object):
    ...
    def __call__(self, img1, img2):
        ...
        return F.rotate(img1, angle, self.resample, self.expand, self.center), F.rotate(img2, angle, self.resample, self.expand, self.center)
...
class RandomAffine(object):
    ...
    def __call__(self, img1, img2):
        ...
        return F.affine(img1, *ret1, resample=self.resample, fillcolor=self.fillcolor), F.affine(img2, *ret2, resample=self.resample, fillcolor=self.fillcolor)
